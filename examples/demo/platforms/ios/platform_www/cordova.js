    ...
    module.exports = {
      ...
      bootstrap: function () {
        ...
        require('cordova/modulemapper').clobbers(
          'cordova/plugin/ios/launchscreen',
  ...
  define('cordova/plugin/ios/statusbar', function (require, exports, module) {
    ...
    Object.defineProperty(statusBar, 'setBackgroundColor', {
      ...
      value: function (value) {
        ...
        var rgbVals = rgbStr.match(/\d+/g).map(function (v) {
        ...
        if (window.StatusBar) {
          window.StatusBar.backgroundColorByHexString(
            '#' +
              rgbVals[0].toString(16).padStart(2, '0') +
              rgbVals[1].toString(16).padStart(2, '0') +
              rgbVals[2].toString(16).padStart(2, '0'),
          );
        } else {
