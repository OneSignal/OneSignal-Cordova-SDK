...
- The Cordova plugin is staged at `ios/capacitor-cordova-ios-plugins/sources/OnesignalCordovaPlugin`.
...
If native config changes are not reflected, rerun `bun run setup:ios` and resolve packages again.
